...
use super::{
    force_directed_graph_async::ForceDirectedGraphAsync, physics_node::PhysicsNode, spring::Spring,
};
...
//             let force_directed_graph = Arc::new(ForceDirectedGraphAsync::new(graph));

//             let b = force_directed_graph.clone();
//             let p = thread::spawn(move || {
//                 graph::force_directed_graph_async::produce_computations(&b);
//             });
